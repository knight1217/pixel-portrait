...
const stylePrompts = {
  ...
  // ===== 3D / Toys (continued) =====
  'anime-figure': 'Turn this photo into a 1/7 scale Japanese anime figurine (NOT chibi Q-version, NOT blind-box style, NOT with display base, NOT with diorama). The face, hair, eye color, gender, ethnicity, pose, and outfit follow the original subject. Adult human body proportions: head is small relative to body (about 1/7 of total height, do NOT enlarge the head). The body is anime style with glossy PVC texture. Keep the original background and lighting.',
