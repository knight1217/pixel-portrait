...
const stylePrompts = {
  ...
  // ===== 3D / Toys (continued) =====
  'anime-figure': 'Transform this subject into a premium Japanese anime figurine (NOT a Q-version chibi, NOT a blind-box style figure, NOT a Funko Pop, NOT a vinyl bobblehead), 1/7 scale proportion with realistic head-to-body ratio (about 7 head heights tall), highly detailed sculpt with painted face and detailed anime eyes, preserving the subject original hair color and style, preserving the subject original eye color and face shape, preserving the subject gender, age, and ethnicity, preserving the subject pose and outfit, glossy PVC figure texture, displayed on a themed environmental base, preserve the original background and lighting from the source photo',
  'lego-minifig': 'Transform this subject into a LEGO minifigure style version of the subject, preserving the subject species, clothing, skin color, facial features, hair color and style, pose, and key features (werewolf stays werewolf, person stays person, dog stays dog), LEGO-style blocky simplified body proportions and cylindrical claw hands, plastic toy texture, preserve the original background and lighting from the source photo',
