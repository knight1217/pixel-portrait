...
const stylePrompts = {
  ...
  'lego-minifig': 'Transform this subject into a LEGO minifigure style version of the subject, preserving the subject species, clothing, colors, fur, and key features (werewolf stays werewolf, person stays person, dog stays dog), blocky LEGO minifigure body and head shape, cylindrical claw hands, plastic toy texture, simple printed face, preserve the original background and lighting from the source photo',
