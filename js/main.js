...
const stylePrompts = {
  ...
  // ===== 3D / Toys (continued) =====
  'anime-figure': 'Transform this subject into an authentic Japanese anime character collectible figure (NOT a Funko Pop, NOT a vinyl bobblehead, NOT in a Funko-style window box), detailed anime sculpt with painted face, preserving the subject original hair color and style, preserving the subject original eye color and face shape, preserving the subject gender, age, and ethnicity, preserving the subject pose and outfit, glossy PVC figure texture, displayed on a simple transparent circular stand with optional themed diorama background, preserve the original background and lighting from the source photo',
