...
const stylePrompts = {
  ...
  'makeup-analysis': 'Create a professional before-and-after comparison visualization from this photo in a split-screen layout. Left side shows the original state, right side shows the enhanced transformation — both with identical framing, camera angle, and lighting for direct comparison. Preserve the subject\'s facial identity across both panels. Clean editorial reference quality with consistent visual presentation.',
  // ===== Design / Product =====
