...
async function handleGenerate(request, env) {
  ...
  try {
    ...
    prompt = prompt + ', high quality, highly detailed, professional lighting, sharp focus, correct anatomy, no extra limbs, no missing limbs, proper fingers, no mutations, no fused body parts, no clipping, well-composed, no watermark, no blur';
